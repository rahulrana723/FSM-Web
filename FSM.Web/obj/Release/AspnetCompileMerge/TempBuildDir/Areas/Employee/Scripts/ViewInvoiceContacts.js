$(document).ready(function () {
    ...
    $(document).on('click', '.btnaddJobcontacts', function () {
        ...
        var InvoicID = $(this).attr("InvoiceId");
        var HideAddContacts = $(this).attr("data-HideAddContacts");
        $.ajax({
            url: common.SitePath + "/Employee/Invoice/_UpdateInvoiceContactsAddEdit",
            data: { CustomerGeneralinfoid: customerGeneralinfoid, SiteId: siteID, InvoiceId: InvoicID, HideAddContacts: HideAddContacts },
            type: 'Get',
            async: false,

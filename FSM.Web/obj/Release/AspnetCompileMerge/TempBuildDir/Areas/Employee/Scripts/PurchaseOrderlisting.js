...
function Deletepurchaseorder(id) {
    ...
    $(".modal-title").html("Delete Purchase Order!");
}
...
$(document).on('click', ".btnconfirm", function () {
    ...
    $.ajax({
        type: 'GET',
        url: common.SitePath + "/Employee/Purchase/DeletePurchaseorder",
        data: { Purchaseid: id },
        async: false,
        success: function (result) {
            ...
            $(".jobalert").delay(2000).fadeOut(function () { window.location.href = common.SitePath + "/Employee/Purchase/ViewPurchaseOrder"; });
        },
        error: function () {
            $(".commonpopup").modal('hide');
        }

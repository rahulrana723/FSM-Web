...
function DisplayImages(fileData, id) {
    $.ajax({
        ...
        success: function (result) {
            ...
            if (id == "SignaturePicture") {
                $("#list_files").append("<tr><td>" + "Signature Picture" + "</td><td>" + fname + "</td><td>" + "<img src='" + FSM.AddEmployeeROOT + fname + "' class='imgSrc' width='74' height='74'/>" + "</td></tr>");
                //$('#divSignaturePic').empty();
                //$('#divSignaturePic').append("<img src='" + FSM.AddEmployeeROOT + fname + "'width='74' height='74'  />");
            }
            else if (id == "ProfilePicture") {
                //$('#divProfilePic').empty();
                $("#list_files").append("<tr><td>" + "Profile Picture" + "</td><td>" + fname + "</td><td>" + "<img src='" + FSM.AddEmployeeROOT + fname + "' class='imgSrc' width='74' height='74'/>" + "</td></tr>");
            }
            else if (id == "DrivingLicense") {
                //$('#divDrivingLicenseImg').empty();
                $("#list_files").append("<tr><td>" + "Driving License" + "</td><td>" + fname + "</td><td>" + "<img src='" + FSM.AddEmployeeROOT + fname + "' class='imgSrc' width='74' height='74'/>" + "</td></tr>");
            }
            else if (id == "BankDetail") {
                //$('#divBankDetailDoc').empty();
                $("#list_files").append("<tr><td>" + "Bank Detail" + "</td><td>" + fname + "</td><td>" + "<img src='" + FSM.AddEmployeeROOT + fname + "' class='imgSrc' width='74' height='74'/>" + "</td></tr>");
            }
            else if (id == "Insurance") {
                //$('#divInsurance').empty();
                $("#list_files").append("<tr><td>" + "Insurance" + "</td><td>" + fname + "</td><td>" + "<img src='" + FSM.AddEmployeeROOT + fname + "' class='imgSrc' width='74' height='74'/>" + "</td></tr>");
            }

...
$('.dashboard_right_block').mousedown(function () {   //if mouse down then menu hide in specify pixel
    if (window.matchMedia('(min-width: 768px)' && '(max-width: 1150px)').matches) {
        $('.dashboard_left_block2').fadeOut('slow', function () {
        });
    }
});
